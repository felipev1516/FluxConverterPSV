...
$icon_directory = "$PSScriptroot\..\..\assets\icons"
$config_directory = "$PSScriptroot\..\..\config"
$supported_file_types = (cat "$config_directory\supported_file_types.cfg")
# File Rename Form
$File_Rename_Form =  New-Object System.Windows.Forms.Form -Property @{
    Text = "File Renaming Tool"
    Size = "620,240"
